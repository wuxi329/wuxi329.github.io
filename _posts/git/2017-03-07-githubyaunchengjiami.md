...
比如2048R/wuxi013里面的wuxi013，2048代表加密轮数，越多越不容易破解
```
gpg --list-keys
```
###### 生成一个测试版本库
...
在你的github上面创建一个project，比如：https://github.com/wuxi

######  配置远端加密版本库
```
git remote add cryptremote gcrypt::git@github.com:wuxi/wuxi.git
```
###### 最好指定用哪个key加密
 这样可以共享这个key给其他人用
```
git config remote.cryptremote.gcrypt-participants "wuxi013"
```
###### push到远端
```
...
###### 下载代码
```
git clone gcrypt::git@github.com:wuxi/wuxi.git test2 // test2是git clone 在本地的文
件名
```
###### 也要指定一下用什么key加密
```
